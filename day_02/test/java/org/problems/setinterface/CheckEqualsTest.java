...
public class CheckEqualsTest {
    ...
    public void testCheckHashSetsEquality() {
        ...
        assertEquals("Equals", CheckEqualsTest.checkHashSetsEquality(arr1, arr2));
    }
    ...
    public void testCheckHashSetsSizeEquality() {
        Integer[] arr1 = {2, 3, 4, 6, 3, 2};
        Integer[] arr2 = {3, 4, 2, 3, 6, 2};
        assertEquals("Equals", CheckEqualsTest.checkHashSetsSizeEquality(arr1, arr2));

        // Different case to test the "not Equals"
        Integer[] arr3 = {1, 2, 3};
        Integer[] arr4 = {3, 2, 1, 4};
        assertEquals("not Equals", CheckEqualsTest.checkHashSetsSizeEquality(arr3, arr4));
    }
}
